...
var workbook = XLSX.readFile('test data repository/forms/Forms test values - Learning Center.xlsx');
...
'Learning Center Form Submission' : function (browser) {
    ...
    browser
        .url('http://www.pacificeast.com/learning-center.aspx?bypassval=y')
