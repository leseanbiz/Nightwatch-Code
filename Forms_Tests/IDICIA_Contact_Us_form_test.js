...
var workbook = XLSX.readFile('test data repository/forms/Forms test values - ID - Contact Us.xlsx');
...
var l = 1;
module.exports = {
'IDICIA Desktop Form Submission Test' : function (browser) {
    
    browser
        .url('http://www.idicia.com/contact-us.aspx?bypassval=y')
    ...
    for (z in worksheet)  
        ...
        switch(true){
            ...
            case (z.indexOf('E') != -1):
                ...
                browser.waitForElementVisible('//*[@id="btnReturn"]', 10000);
                browser.click('//*[@id="btnReturn"]');//this button click will not function. I have asked Kevin why this would be the case. awaiting response..
                browser.useCss(); 
...
//html/body/div[1]/div/div[9]/form/table/tbody/tr/td/div/table/tbody/tr[2]/td/input[1]
