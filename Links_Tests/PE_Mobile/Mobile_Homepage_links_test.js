...
module.exports = {
'Mobile Homepage Link Test' : function (browser) {
    ...
    browser.url("http://www.pacificeast.com/phone/");
    ...
    browser.verify.visible('a[href*="contact.html"]', 'products/phone_append.aspx is visible!');
...
http://www.pacificeast.com/phone/#
*/