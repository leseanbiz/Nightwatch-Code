...
module.exports = {
'Technology Link Test' : function (browser) {
    ...
    browser.url("http://www.pacificeast.com/technology.aspx");
    ...
    //browser.verify.visible('a[href*="www.openidentityexchange.org/"]','found!');
    //browser.verify.visible('a[href*="www.diacc.ca/"]','found!');
    //browser.verify.visible('a[href*="www.openid.net/"]','found!');
    //browser.verify.visible('a[href*="www.itac.ca/"]','found!');
    //browser.verify.visible('a[href*="blog/post/2016/01/18/open-identity-standards-enable-greater-privacy-and-control.aspx"]','found!');
    //browser.verify.visible('a[href*="blog/post/2016/01/07/pacificeast-s-war-on-fraud-part-3.aspx"]','found!');
    //browser.verify.visible('a[href*="blog/post/2015/11/10/pacificeast-s-war-on-fraud-part-2.aspx"]','found!');
