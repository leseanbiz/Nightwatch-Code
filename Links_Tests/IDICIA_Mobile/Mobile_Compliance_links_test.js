...
module.exports = {
'Mobile Compliance Link Test' : function (browser) {
    ...
    browser.url("http://www.idicia.com/phone/compliance.html");
    ...
    //browser.verify.hidden('a[href*="http://www.idicia.com/index.html?devicelock=desktop"]','found!');
