...
module.exports = {
'About Us Links Test' : function (browser) {
    ...
    browser.url("http://www.pacificeast.com/about_us.aspx");
    browser.waitForElementVisible('body',1000);
    //browser.verify.hidden('a[href*="www.pacificeast.com/"]','found http://www.pacificeast.com/!');
    ...
    //browser.verify.visible('a[href*="about_us.aspx#SiteMapPath1_SkipLink"]','found!');
    browser.verify.visible('a[href*="Default.aspx"]','found!');
    ...
    //browser.verify.hidden('a[href*="about_us.aspx#"]','found!');
    browser.end();
    }
