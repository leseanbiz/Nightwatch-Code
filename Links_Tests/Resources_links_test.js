...
module.exports = {
'Resources Link Test' : function (browser) {
    ...
    browser.url("http://www.pacificeast.com/resources.aspx");
    ...
    browser.verify.visible('a[href*="http://www.bbb.org/oregon/business-reviews/data-systems-consultants-and-designers/pacific-east-research-in-beaverton-or-22679260#bbbseal"]','found!');
    browser.verify.visible('a[href*="openidentityexchange.org/"]','found!');
    browser.verify.visible('a[href*="www.diacc.ca"]','found!');
    browser.verify.visible('a[href*="www.openid.net"]','found!');
    browser.verify.visible('a[href*="www.isc2.org"]','found!');
    browser.verify.visible('a[href*="www.abbotsfordchamber.com"]','found!');
    browser.verify.visible('a[href*="resources/pdfs/getting_you_started.pdf"]','found!');
    browser.verify.visible('a[href*="resources/pdfs/credit_application.pdf"]','found!');
    browser.verify.visible('a[href*="resources/pdfs/credit_card_authorization_one-time_use.pdf"]','found!');
    browser.verify.visible('a[href*="resources/pdfs/credit_card_authorization_multiple_use.pdf"]','found!');
    browser.verify.visible('a[href*="resources/pdfs/bus61-can-spam-act-compliance-guide-business.pdf"]','found!');
    browser.verify.visible('a[href*="blog/syndication.axd"]','found!');
    browser.verify.visible('a[href*="https://secure.pacificeast.com/clientportal/"]','found!');
    browser.verify.hidden('a[href*="site_map.aspx"]','found!');
    browser.verify.visible('a[href*="http://zip4.usps.com/zip4/welcome.jsp"]','found!');
    browser.verify.visible('a[href*="http://www.canadapost.ca/cpotools/apps/fpo/personal/findPostOfficeByAdvancedQuery?execution=e1s1"]','found!');
    browser.verify.visible('a[href*="http://telemarketing.donotcall.gov/"]','found!');
