...
module.exports = {
'IDICIA Verification Link Test' : function (browser) {
    ...
    browser.url("http://www.idicia.com/verification.html");
    ...
    browser.verify.visible('a[href*="telified.html"]','found telified');
