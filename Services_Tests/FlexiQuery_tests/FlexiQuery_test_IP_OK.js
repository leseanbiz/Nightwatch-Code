        ...
        else if (z.indexOf('B') != -1)
        {
            ...
            //console.log(firstNamesI[j]);
                ...
                else if (z.indexOf('F') != -1)
                {
                        ...
                        if (proxiesR != "blank") 
                        {
                            browser.verify.containsText('table[id="resultsGrid"]',proxiesR[jR],"Verification found in results for: " + jobCodesI[i]);    
                        }
                        if (locationsR != "blank") 
                        {
                            browser.verify.containsText('table[id="resultsGrid"]',locationsR[kR],"Age found in results for: " + jobCodesI[i]);    
                        }
                        if (zipsR != "blank") 
                        {
